...
def result_summary(seed):
    path = str(os.getcwd()) + "/adversarial-training/result/perturb_data_only/seed" + str(seed) + "/"
    ...
    result.to_csv(os.getcwd() + r'/result-analysis/adv-training/seed'+str(seed)+"-perturb_data_only.csv", index=False)
